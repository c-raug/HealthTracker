...
- **Runtime**: Expo SDK 55, React Native 0.83.6
...
- **Dev client (replaces Expo Go)**: The project uses `expo-dev-client` for iOS debugging. Build to the iPhone once via Xcode (free personal team signing, 7-day cycle), then `npm start` + open the HealthTracker dev client app. Same hot-reload/DevMenu experience as Expo Go but supports SDK 55 native modules on iOS 26.
